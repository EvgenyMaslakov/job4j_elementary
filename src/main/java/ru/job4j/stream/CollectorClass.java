 ...
 * набора элементов к чему-то одному. Например, использование коллекторов предполагает
 * сведение результата чаще всего к коллекции. Но так же есть и другие способы редукции,
 * их мы разберем позже.
 *
 * Рассмотрим пример, создания произвольного коллектора. Собирать будем в связный список.
 * Добавление будет идти всегда в начало
 *
 *
 *
 * Результат
