 ...
 * Как вы наверное уже догадались поиск минимального элемента представляет собой
 * также редукцию. Этот метод принимает Comparator и возвращает Optional.
 * Если список пуст вернется пустой Optional.
 *
 * Пример,
 *
 * Integer min = List.of(3, 2, 1).stream().min((n1, n2) ->
