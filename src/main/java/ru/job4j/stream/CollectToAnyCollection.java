 ...
 * Например,
 *
 * List<Integer> result = List.of(1, 2).stream().collect(Collectors
 * .toCollection(LinkedList::new));
 *
 * В качестве аргумента мы указываем создание пустой коллекции, в которую будут
 * собираться наши значение. В примере выше мы получим реализацию List,
 * но только теперь LinkedList.
 *
