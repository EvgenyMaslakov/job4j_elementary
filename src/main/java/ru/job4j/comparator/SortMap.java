 ...
 *
 * Методов сортировки Map нет. Мы можем только получить отсортированную мапу
 * через создание новой из исходной.
 * При данном подходе упорядочивание происходит аналогично, как через Set.
 *
 * Например:
 *
 * Map<Integer, Integer> map = new TreeMap<>(Map.of(2, 4, 1, 1));
 * получим пары (1, 1), (2, 4) произошло
 * упорядочивание в естественном порядке
 *
 * Ваша задача получить отсортированную мапу из исходной.
