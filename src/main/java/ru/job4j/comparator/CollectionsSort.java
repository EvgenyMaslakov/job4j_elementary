 ...
 *
 * Существует альтернативный способ сортировки списка. В себе он использует
 ...
 * поэтому сортировка
 * идет в естественном порядке
 *
 * Ваша задача отсортировать переданный список строк, используя метод
 * Collections.sort(), в восходящем порядке.
